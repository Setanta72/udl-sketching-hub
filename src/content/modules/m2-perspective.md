...
concepts:
  - id: "horizon-line-vp"
    ...
    inlineExamples:
      - id: "cone-of-vision"
        type: "image"
        url: "/images/m2-cone-of-vision.jpg"
        caption: "Diagram showing the 60-degree cone of vision and how distortion occurs outside it"
        level: "proficient"
    ...
    drills:
      - title: "VP Placement Exercise"
        ...
        options:
          - title: "Option A: Technical Cubes"
            description: "Draw 10 perfect cubes with VPs on page using a ruler. Focus on mathematical accuracy."
            difficulty: "beginner"
          - title: "Option B: City Block"
            description: "Draw a simple street corner with 3 buildings using estimated VPs. Focus on the feeling of depth."
